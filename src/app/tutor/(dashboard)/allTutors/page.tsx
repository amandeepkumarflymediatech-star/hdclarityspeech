...
export default async function TutorDirectoryPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-black text-primary font-playfair tracking-tight mb-2">Platform Mentors</h1>
        <p className="text-primary/60">Connect with other communication coaches on the platform.</p>
      </div>
          ...
          <div key={tutor.id} className="bg-white rounded-2xl p-6 border border-secondary/30 shadow-sm hover:shadow-md transition-shadow group flex flex-col h-full">
            ...
            <div className="flex-1">
              <p className="text-sm text-primary/70 line-clamp-3 mb-4 leading-relaxed">
                {tutor.bio || 'An experienced mentor ready to help.'}
              </p>
